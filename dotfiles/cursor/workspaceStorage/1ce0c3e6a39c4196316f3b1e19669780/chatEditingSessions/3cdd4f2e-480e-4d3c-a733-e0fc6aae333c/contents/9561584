...
() {
  ...
  typeset -g POWERLEVEL9K_VCS_BACKGROUND=235 # Cambiado a 25292f en formato numérico

  # Git status formatting
  # Eliminé las referencias a my_git_formatter para evitar errores
  ...
  # Git visual identifier color
  typeset -g POWERLEVEL9K_VCS_VISUAL_IDENTIFIER_COLOR=76
  typeset -g POWERLEVEL9K_VCS_LOADING_VISUAL_IDENTIFIER_COLOR=244

  # Git segment separators
  typeset -g POWERLEVEL9K_LEFT_SEGMENT_SEPARATOR='\uE0B0'
  typeset -g POWERLEVEL9K_RIGHT_SEGMENT_SEPARATOR='\uE0B2'
